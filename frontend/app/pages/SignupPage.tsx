        ...
        <div className="w-full max-w-sm">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-gray-900 mb-1" style={{ fontWeight: 700, fontSize: "1.5rem" }}>Create your account</h1>
              <p className="text-sm text-gray-500">Start analyzing your content for free</p>
            </div>
                      ...
                      {[1, 2, 3].map((level) => (
                        <div
                          ...
                          className={`h-1 flex-1 rounded-full transition-all ${
                            passwordStrength >= level ? strengthColors[passwordStrength] : "bg-gray-100"
                          }`}
                        />
                      ))}
                    </div>
                    <p className="text-xs text-gray-400 mt-1">{strengthLabels[passwordStrength]}</p>
                  </div>
                )}
              </div>
            ...
            <div className="mt-4 flex flex-col gap-1.5">
              {["100 free analysis credits to start", "No credit card required"].map((item) => (
